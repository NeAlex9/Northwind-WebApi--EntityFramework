    ...
    public class ProductService : IProductService
    {
        ...
        public async Task<bool> DeleteProductAsync(int productId)
        {
            var product = await this.context
                .Products
                .Where(product => productId == product.CategoryId)
                .FirstOrDefaultAsync();
            if (product is null)
            {
                return false;
        ...
        public async IAsyncEnumerable<Product> GetProductsByNameAsync(ICollection<string> names)
        {
            ...
            var productsDto = this.context
                .Products
                .AsNoTracking()
                .Where(product => names.Any(name => name == product.ProductName))
                .AsAsyncEnumerable();
        ...
        private static void UpdateProductDto(ProductDTO dto, Product product)
        {
